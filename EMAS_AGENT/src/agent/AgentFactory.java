...
public class AgentFactory {
	...
	private double genotypeRandomnessFactor = 0.2; // factor which defines the
	...
	public Agent createAgent() throws WrongGenotypeException {
		Agent agent = new Agent(energyLossFactor, genotypeRandomnessFactor,
				energyOnStart, fitnessEvaluator);
		return agent;
	}
